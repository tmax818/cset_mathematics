...
*** Prove that the Pythagorean Theorem is equivalent to the trigonometric identity sin2x + cos2x = 1 and that this identity leads to 1 + tan2x = sec2x and 1 + cot2x = csc2x
